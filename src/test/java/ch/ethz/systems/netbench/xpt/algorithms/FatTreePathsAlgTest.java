...
public class FatTreePathsAlgTest {
    ...
    public void testPathFromVToLevel(){
        ...
        Set<Vertex> coreSet = alg.getPathFromVToLevel(new Vertex(5),2,predecessors);
        ...
        predecessors.clear();
        coreSet = alg.getPathFromVToLevel(new Vertex(5),1,predecessors);
        ...
        predecessors.clear();
        coreSet = alg.getPathFromVToLevel(new Vertex(5),0,predecessors);
        ...
        coreSet = alg.getPathFromVToLevel(new Vertex(5),2,predecessors);
       // System.out.println(Arrays.toString(predecessors.entrySet().toArray()));
